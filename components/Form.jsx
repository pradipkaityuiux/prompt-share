      ...
      >
        ...
        <label htmlFor="prompt">
          <span className='font-satoshi font-semibold text-base text-gray-500'>
            Tag {' '}
            <span className='font-normal'>(#webdev, #idea, #image)</span>
            </span>
          <input
            value={post.tag}
        ...
        <div className='flex-end mx-3 mb-5 gap-4'>
          ...
          <button type='submit' disabled={submitting} className='px-5 py-1.5 text-sm bg-orange-400 text-white rounded-full'>{submitting ? `${type}...` : type}</button>
        </div>
      </form>
    </section>
  )
